...
| Docker host | Provides container isolation. Agent containers cannot reach other Litchi service containers on the internal network by default. |
...
4. The agent service posts the PR URL as a comment on the Litchi task.
